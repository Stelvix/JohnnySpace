            ...
            <div className="grid gap-5 lg:grid-cols-[1.8fr_0.9fr]">
              ...
              <div className="flex flex-col gap-4 rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,_rgba(18,33,49,1),_rgba(11,20,29,1))] p-5 shadow-[0_18px_30px_rgba(0,0,0,0.18)]">
                <div className="rounded-[18px] border border-white/10 bg-[#0d1c2d] p-4">
                  <p className="text-[11px] uppercase tracking-[0.12em] text-[#8ca8bb]">État</p>
                  <p className="mt-3 text-2xl font-semibold text-[#edf7ff]">Très bon</p>
                </div>
                <div className="rounded-[18px] border border-white/10 bg-[#0d1c2d] p-4">
                  <p className="text-[11px] uppercase tracking-[0.12em] text-[#8ca8bb]">Dernière vérification</p>
                  <p className="mt-3 text-lg font-semibold text-[#dfeaf7]">08:00 aujourd’hui</p>
                </div>
                <div className="rounded-[18px] border border-white/10 bg-[#0d1c2d] p-4">
                  <p className="text-[11px] uppercase tracking-[0.12em] text-[#8ca8bb]">Besoin d’eau</p>
                  <p className="mt-3 text-lg font-semibold text-[#6ffbbe]">Hydratation idéale</p>
                </div>
              </div>
            </div>
          </section>
